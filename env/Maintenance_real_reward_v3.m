classdef Maintenance_real_reward_v3 < rl.env.MATLABEnvironment& Abs_Maintenance_env
...
%         state2
    ...
    methods              
        ...
        function this = Maintenance_real_reward_v3(param, unit, th, cap_w, noworkload, unboundedAgent, agentUseDiscrete, strictPenalty, addGroupVar, noWorkloadState)
