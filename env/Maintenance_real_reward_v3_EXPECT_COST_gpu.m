classdef Maintenance_real_reward_v3_EXPECT_COST_gpu < rl.env.MATLABEnvironment& Abs_Maintenance_env
...
%         state2
    ...
    methods              
        ...
        function this = Maintenance_real_reward_v3_EXPECT_COST_gpu(param, unit, th, cap_w, noworkload, unboundedAgent, agentUseDiscrete, strictPenalty, addGroupVar, noWorkloadState, incentivized, show_every_rewards, discretize_states, show_progress)
...
%             updateActionInfo(this);
        ...
        function replace_mc(this, idx_mc)
            ...
            this.mean_unit2(idx_mc) = this.mean_beta;
            this.var_unit2(idx_mc) = this.var_beta;
...
%             this.a_shape= (this.mean_global .* this.mean_global).*(this.b_shape+ (ones(1,this.unit) *1))/(this.var_global.*this.b_shape);
%             this.sample_a = gamrnd(this.a_shape,this.b_shape, [1,this.unit]);
%             this.b = this.var_global ./ (this.mean_global.*(this.b_shape+ (ones(1,this.unit) *1))) ;
%             
%             
%             %GAMMA DISTRIBUTION Given b
%             this.b= ones(1,this.unit) *0.01;
%             this.b_shape = (this.var_global ./ (this.b .* this.mean_global))-(ones(1,this.unit) *1) ;
