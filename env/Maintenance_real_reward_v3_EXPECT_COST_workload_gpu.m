classdef Maintenance_real_reward_v3_EXPECT_COST_workload_gpu < rl.env.MATLABEnvironment& Abs_Maintenance_env
...
%         state2
    ...
    methods              
        ...
        function this = Maintenance_real_reward_v3_EXPECT_COST_workload_gpu(param, unit, th, cap_w, noworkload, unboundedAgent, agentUseDiscrete, strictPenalty, addGroupVar, noWorkloadState, incentivized, show_every_rewards, discretize_states, show_progress)
