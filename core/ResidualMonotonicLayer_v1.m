classdef ResidualMonotonicLayer_v1 < nnet.layer.Layer & nnet.layer.Formattable & nnet.layer.Acceleratable
    ...
    methods
        function this = ResidualMonotonicLayer_v1(monotonicChannels,lipschitzConstant,dim)
