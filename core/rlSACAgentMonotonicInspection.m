function agent = rlSACAgentMonotonicInspection(varargin)
...
%     numHiddenUnits =[32 32 32 prod(ActionInfo.Dimension)];
    ...
    if monotonic_required
        ...
        if prod(ActionInfo.Dimension) > 1
            tempLayers = ResidualMonotonicLayer_v2(monotonicChannels,prod(ActionInfo.Dimension)*ubLipschitzConstant,prod(ActionInfo.Dimension));
