...
is_tested_version = false; 
evaluated_iteration = 30;
is_evaluated_policy = true;
...
nTrainingEpisodes = 50; %1000; %1000; %30 %100 %200
...
%% 2 Threshold in case that we don't want training
th_policy_isUpLowSpecified = false;  
defined_opt_lower_th = 14.25 ;
defined_opt_upper_th = 15.25 ;