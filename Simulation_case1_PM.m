...
%% Define setting
methodList = [[TYPE_METHOD.SAC_GRP_LOOKAHEAD],[TYPE_METHOD.SAC_NOGRP],[TYPE_METHOD.PPO_CACT],[TYPE_METHOD.TRPO_CACT_CSTA],[TYPE_METHOD.DDPG],[TYPE_METHOD.DQN],[TYPE_METHOD.THRESHOLD_2TH],[TYPE_METHOD.THRESHOLD],[TYPE_METHOD.PERIODICAL],[TYPE_METHOD.DO_NOTHING],[TYPE_METHOD.MAINTAIN_EVERYTIME]];

%% Environment
env_type = 'Complex-THRPUT';
settingFileName = 'manufacturingCellSetting_case1';  
