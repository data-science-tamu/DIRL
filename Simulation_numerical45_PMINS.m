...
%% Define setting
methodList = [[TYPE_METHOD.SAC_GRP_LOOKAHEAD],[TYPE_METHOD.SAC_NOGRP],[TYPE_METHOD.THRESHOLD_2TH],[TYPE_METHOD.THRESHOLD],[TYPE_METHOD.PERIODICAL],[TYPE_METHOD.DO_NOTHING],[TYPE_METHOD.MAINTAIN_EVERYTIME]];

%% Environment
env_type = 'Complex-THRPUT';
settingFileName = 'manufacturingCellSetting_numerical2';  
...
for rep = 1:numReplication
    for fileID=1:length(methodList)
        ...
        proportion_LossTPInspection = 0.05;  
